...
pd.DataFrame([o.__dict__() for o in cpi.areas.all()]).to_csv(
    "./data/areas.csv", index=False
)
pd.DataFrame([o.__dict__() for o in cpi.items.all()]).to_csv(
    "./data/items.csv", index=False
)
